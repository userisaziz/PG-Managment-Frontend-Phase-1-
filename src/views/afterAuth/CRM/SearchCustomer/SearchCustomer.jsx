...
// import { searchUser } from '../Redux/actionCreator';
import { searchCustomerHeader } from './SearchCustomerHeader';
import { Button, Input, Table, Typography, CustomSelect, Dropdown } from '../../../../components';
	...
	return (
		<div className="SearchCustomer">
			<div className="SearchCustomer__wrapper">
				...
				<Typography className="UserManagementTable--Title">Search Customer</Typography>
				<form onSubmit={handleFormSubmit}>
					<div className="SearchCustomer__inputs">
						<div className="SearchCustomer__customer__input">
							{/* <CustomSelect
								label="Search by"
